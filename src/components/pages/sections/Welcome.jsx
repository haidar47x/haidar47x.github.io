    ...
    <div className="relative flex flex-col items-center gap-12 overflow-x-hidden pt-24 pb-4 md:gap-16 md:py-24">
      ...
      <div className="mt-2 w-10/12 text-lg tracking-tight md:tracking-[-0.9px] md:w-8/12 md:text-xl lg:w-8/12 xl:w-6/12">
        <p>
          ...
          and deploying robust and scalable backend systems. My core expertise includes Java, Spring Boot, and DevOps. When I'm not coding, I write about it publicly. Sporadically, I develop full-stack apps as a freelancer on Upwork.
        </p>
